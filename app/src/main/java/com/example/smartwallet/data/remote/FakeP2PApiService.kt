...
class FakeP2PApiService : P2PApiService {
    ...
    override suspend fun sendMoney(
        ...
        val debit = sender.copy(balance = sender.balance - amount)
        val credit = receiver.copy(balance = receiver.balance + amount)
        updateUsers(debit, credit)

        val transaction = Transaction(
            id = System.currentTimeMillis(),   // ✔ Long, not String
